...
def plot(sside: int, rect: list[Rect], saveto: str | None = None) -> None:
    """Plot a list of rectangles inside a scene.

    Args:
        sside: Length of the side of the scene.
        rect: List of rectangles.
        saveto: Path to save the figure. If None, show it on screen.
    """
    plt.figure()
    plt.xlim(0, sside)
    plt.ylim(0, sside)
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate rectangle regions hypergraph instance."
    )
    parser.add_argument("nrectangles", type=int, help="Number of rectangles.")
    parser.add_argument("width", type=int, help="Width as percentage of side.")
    parser.add_argument("height", type=int, help="Height as percentage of side.")
    ...
    for i in range(ninstances):
        ...
        plot(side, rectangles, saveto=out + "/" + name + ".png")
