                                     ...
                                     const int nweights[])
{
   ...
   for (i = 0; i < G->ncount; ++i) {
      if (nweights[i] == 0) {
         ...
         /* Removed "&& a < i" from the condition of the following loop. 
         As it supossed that the adjacent list had increasing order. 
         Done by Lucci et al. (2025) */
         for (a_i = 0; a_i < G->nodelist[i].degree; ++a_i) {
